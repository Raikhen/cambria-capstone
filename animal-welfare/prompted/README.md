# Prompted baseline (shared arm for the `sdf` and `steering` tracks)
...
- The 12 self-authored MC booking scenarios in `../shared/data/` are a sanity check only — too small and too self-referential to report.
